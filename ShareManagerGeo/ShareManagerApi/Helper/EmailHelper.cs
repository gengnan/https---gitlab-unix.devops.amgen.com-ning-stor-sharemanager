...
namespace ShareManagerApi.Helper
{
    public static class EmailHelper
    {
        ...
        public static bool SendNewRequestNotificationMessage(CifsPermissionRequest request, CifsShare share)
        {
            ...
            string domain = db.Ous.Find(share.OuID).Domain.ToString();
            List<AdUser> users = AdHelper.GetAdGroupMembers(groupName,domain);
            ...
            "<TD>";
            var groupmembers = AdHelper.GetAdGroupMembers(share.OwnerGroup,domain);
            body += "</BR><UL>";
        ...
        public static bool SendReminderRequestNotificationMessage(CifsPermissionRequest request, CifsShare share)
        {
            ShareContext db = new ShareContext();
            ...
            aliases.Add(request.RequestedByUserAlias + "@amgen.com"); //adding "requested by" alias to the "To:" field because some people filter emails if they are cc'ed.
            ...
            int requestCancellationTimeWindowInDays = Int32.Parse(ConfigurationManager.AppSettings["requestCancellationTimeWindowInDays"]); //14 days
            DateTime endDate = (DateTime)(request.RequestOpenedOnDateTime);
            endDate = endDate.AddDays(requestCancellationTimeWindowInDays);
            int remainingDays = (int)(endDate - DateTime.Now).TotalDays;
            
            string subject = Resources.Resources.ActionRequired + " " + Resources.Resources.ReminderRequestPending + " " + share.UncPath + " - " + Resources.Resources.ApplicationName;
            string body = "<html><head><style type=\"text/css\">body{font-family: Arial, Helvetica, sans-serif;   font-size:10pt;   background-color:#ffffff;}" +
            "tr,td{font-family: Arial, Helvetica, sans-serif;" +
               "font-size:10pt;" +
               "background-color:#ffffff;}" +
            "span.sig{font-style:italic;" +
                   ...
                   "color:#811919;}" +
            "</style></head>" +
            "<body><p>" + Resources.Resources.ApplicationName + " - " + Resources.Resources.ReminderRequestPending + " " + share.UncPath + "</p>" +
            "<p><b><u>" + Resources.Resources.ReminderImmediateActionRequired1 + remainingDays.ToString() + Resources.Resources.Days + "</u></b><br/>" + Resources.Resources.ReminderImmediateActionRequired2 + " </p>" +
            "<p><b><u>" + Resources.Resources.WhatToKnow + "</u></b></p>" +
            "<p>" + Resources.Resources.RequestMade + "</p>" +
            "<p><TABLE><TR><TD style=\"padding-right:2px;text-align:right;\"><b>" + Resources.Resources.ShareName + "</b>:&nbsp;</TD>" +
            "<td>" + share.Name + "</td>" +
        ...
        public static bool SendCancellationNotificationMessage(CifsPermissionRequest request, CifsShare share)
        {
            ShareContext db = new ShareContext();
            ...
            ccs.Add(request.RequestedByUserAlias + "@amgen.com");
            string subject = Resources.Resources.Cancelled + " " + share.UncPath + " - " + Resources.Resources.ApplicationName;
            string body = "<html><head><style type=\"text/css\">body{font-family: Arial, Helvetica, sans-serif;   font-size:10pt;   background-color:#ffffff;}" +
            "tr,td{font-family: Arial, Helvetica, sans-serif;" +
               "font-size:10pt;" +
               "background-color:#ffffff;}" +
            "span.sig{font-style:italic;" +
                   ...
                   "color:#811919;}" +
            "</style></head>" +
            "<body><p>" + Resources.Resources.ApplicationName + " - " + Resources.Resources.Cancelled + " " + share.UncPath + "</p>" +
            "<p><b><u>" + Resources.Resources.WhatToKnow + "</u></b></p>" +
            "<p>" + "<b>" + Resources.Resources.CancelledRequestMessage + "</b>" + 
            "<p><TABLE><TR><TD style=\"padding-right:2px;text-align:right;\"><b>" + Resources.Resources.ShareName + "</b>:&nbsp;</TD>" +
            "<td>" + share.Name + "</td>" +
            "<TR><TD style=\"padding-right:2px;text-align:right;\"><b>" + Resources.Resources.UncPath + "</b>:&nbsp;</TD>" +
            "<TD>" + share.UncPath + "</TD></TR>" +
            ...
            body += "<TR><TD style=\"padding-right:2px;text-align:right;\"><b>" + Resources.Resources.RequestOpenedOnDateTime + "</b>:&nbsp;</TD>" +
            "<TD>" + request.RequestOpenedOnDateTime + "</TD></TR>" +
            "<TR><TD style=\"padding-right:2px;text-align:right;\"><b>" + Resources.Resources.RequestStatus + "</b>:&nbsp;</TD>" +
            "<TD>" + RequestStatusExt.AsDisplayString(request.RequestStatus.Value) + "</TD></TR>" +
            "</TABLE></p><p>" +
        ...
        public static bool SendRequestCompletedEmailMessage(CifsPermissionRequest request, CifsShare share)
        {
           ...
           "<p>" + Resources.Resources.EmailClosingP2 + " " + ou.ResolverGroup + " " + Resources.Resources.EmailClosingP3 + "</p>";
